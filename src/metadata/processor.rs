            ...
            (
                ...
                hashmap![
                    path.join("ALBUM_01") => btreemap![
                        MetaKey::from("ALBUM_01_item_key") => MetaVal::Str("ALBUM_01_item_val".to_owned()),
                        MetaKey::from("const_key") => MetaVal::Str("const_val".to_owned()),
                        MetaKey::from("item_key") => MetaVal::Str("item_val".to_owned()),
                        MetaKey::from("overridden") => MetaVal::Str("ALBUM_01_item".to_owned()),
                    ],
                    path.join("ALBUM_02") => btreemap![
                        MetaKey::from("ALBUM_02_item_key") => MetaVal::Str("ALBUM_02_item_val".to_owned()),
                        MetaKey::from("const_key") => MetaVal::Str("const_val".to_owned()),
                        MetaKey::from("item_key") => MetaVal::Str("item_val".to_owned()),
                        MetaKey::from("overridden") => MetaVal::Str("ALBUM_02_item".to_owned()),
                    ],
                    path.join("ALBUM_03") => btreemap![
                        MetaKey::from("ALBUM_03_item_key") => MetaVal::Str("ALBUM_03_item_val".to_owned()),
                        MetaKey::from("const_key") => MetaVal::Str("const_val".to_owned()),
                        MetaKey::from("item_key") => MetaVal::Str("item_val".to_owned()),
                        MetaKey::from("overridden") => MetaVal::Str("ALBUM_03_item".to_owned()),
                    ],
                    path.join("ALBUM_04.flac") => btreemap![
                        MetaKey::from("ALBUM_04_item_key") => MetaVal::Str("ALBUM_04_item_val".to_owned()),
                        MetaKey::from("const_key") => MetaVal::Str("const_val".to_owned()),
                        MetaKey::from("item_key") => MetaVal::Str("item_val".to_owned()),
                        MetaKey::from("overridden") => MetaVal::Str("ALBUM_04_item".to_owned()),
                    ],
                    path.join("ALBUM_05") => btreemap![
                        MetaKey::from("ALBUM_05_item_key") => MetaVal::Str("ALBUM_05_item_val".to_owned()),
                        MetaKey::from("const_key") => MetaVal::Str("const_val".to_owned()),
                        MetaKey::from("item_key") => MetaVal::Str("item_val".to_owned()),
                        MetaKey::from("overridden") => MetaVal::Str("ALBUM_05_item".to_owned()),
                    ],
                ],
            ),
            // (
    ...
    fn test_process_item_file() {
        ...
        let inputs_and_expected = vec![
            (
                path.to_owned(),
                btreemap![
                    MetaKey::from("ROOT_self_key") => MetaVal::Str("ROOT_self_val".to_owned()),
                    MetaKey::from("const_key") => MetaVal::Str("const_val".to_owned()),
                    MetaKey::from("self_key") => MetaVal::Str("self_val".to_owned()),
                    MetaKey::from("overridden") => MetaVal::Str("ROOT_self".to_owned()),
                ],
            ),
            (
                path.join("ALBUM_01"),
                btreemap![
                    MetaKey::from("ALBUM_01_item_key") => MetaVal::Str("ALBUM_01_item_val".to_owned()),
                    MetaKey::from("ALBUM_01_self_key") => MetaVal::Str("ALBUM_01_self_val".to_owned()),
                    MetaKey::from("const_key") => MetaVal::Str("const_val".to_owned()),
                    MetaKey::from("item_key") => MetaVal::Str("item_val".to_owned()),
                    MetaKey::from("self_key") => MetaVal::Str("self_val".to_owned()),
                    MetaKey::from("overridden") => MetaVal::Str("ALBUM_01_self".to_owned()),
                ],
            ),
            (
                path.join("ALBUM_01").join("DISC_01").join("TRACK_01.flac"),
                btreemap![
                    MetaKey::from("TRACK_01_item_key") => MetaVal::Str("TRACK_01_item_val".to_owned()),
                    MetaKey::from("const_key") => MetaVal::Str("const_val".to_owned()),
                    MetaKey::from("item_key") => MetaVal::Str("item_val".to_owned()),
                    MetaKey::from("overridden") => MetaVal::Str("TRACK_01_item".to_owned()),
                ],
            ),
        ];
